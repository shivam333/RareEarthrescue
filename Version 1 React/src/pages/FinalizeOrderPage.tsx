    ...
    <motion.main className="page" {...pageMotionProps}>
      <section className="shell section-gap pt-10 lg:pt-14">
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[110px_minmax(0,1.16fr)_minmax(360px,0.84fr)]">
          ...
          <article className="overflow-hidden rounded-[34px] border border-[#DCE3EF] bg-[rgba(255,252,247,0.96)] shadow-[0_28px_80px_rgba(46,41,31,0.08)]">
          ...
          <aside className="rounded-[34px] border border-[#DCE3EF] bg-[linear-gradient(180deg,rgba(255,252,247,0.98),rgba(244,236,224,0.92))] p-6 shadow-[0_28px_80px_rgba(46,41,31,0.08)]">
            ...
            <div className="mt-6 rounded-[28px] border border-[#DCE3EF] bg-white/84 p-5">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  <span className="text-[0.66rem] font-extrabold uppercase tracking-[0.18em] text-[#6D7484]">
                    Bid basis
                  </span>
                  <strong className="mt-2 block font-display text-[2.1rem] leading-none tracking-[-0.06em] text-[#0F1115]">
                    ${openingBidFloor.toFixed(2)} / kg
                  </strong>
                </div>
                <span className="rounded-full border border-[#DCE3EF] bg-[#DDF1E8] px-4 py-2 text-[0.72rem] font-bold uppercase tracking-[0.14em] text-[#253B80]">
              ...
              <div className="mt-5 rounded-[24px] border border-[#DDF1E8] bg-[linear-gradient(135deg,rgba(233,244,235,0.92),rgba(247,241,232,0.92))] px-5 py-4">
                <span className="text-[0.68rem] font-extrabold uppercase tracking-[0.18em] text-[#253B80]">
                  Seller-managed logistics
                </span>
                <p className="mt-2 text-[0.96rem] leading-7 text-[#6D7484]">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div>
                  <label
                    ...
                    className="text-[0.66rem] font-extrabold uppercase tracking-[0.18em] text-[#6D7484]"
                  >
                    Bid price / kg
                  </label>
                  <div className="mt-3 rounded-[28px] border border-[#DCE3EF] bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(251,247,239,0.96))] px-6 py-5 shadow-[0_16px_40px_rgba(46,41,31,0.06)]">
                    <input
                      id="final-bid-price"
                      type="number"
                      inputMode="decimal"
                      ...
                      className="w-full border-0 bg-transparent font-display text-[2.4rem] tracking-[-0.05em] text-[#253B80] outline-none"
                    />
                    <span className="mt-2 block text-[0.74rem] font-bold uppercase tracking-[0.14em] text-[#6D7484]">
                      Opening floor: ${openingBidFloor.toFixed(2)} / kg
                    </span>
                    {!isBidPriceValid ? (
                      <span className="mt-2 block text-[0.74rem] font-semibold text-[#C8AA48]">
                ...
                <div>
                  ...
                  <div className="mt-3 rounded-[28px] border border-[#DCE3EF] bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(251,247,239,0.96))] px-6 py-5 shadow-[0_16px_40px_rgba(46,41,31,0.06)]">
                    <input
                      ...
                      className="w-full border-0 bg-transparent font-display text-[2.4rem] tracking-[-0.05em] text-[#253B80] outline-none placeholder:text-[#6D7484]"
                    />
                    <span className="mt-2 block text-[0.74rem] font-bold uppercase tracking-[0.14em] text-[#6D7484]">
                      Tons · max 2 decimals
                    </span>
                ...
                <div className="rounded-[24px] border border-[#DCE3EF] bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(247,241,232,0.84))] p-4">
                  <div className="flex items-center justify-between gap-3">
                    <span className="text-[0.74rem] font-bold uppercase tracking-[0.14em] text-[#6D7484]">
                      Total bid
                    </span>
                    <strong className="font-display text-[2rem] tracking-[-0.05em] text-[#0F1115]">
                      ${Number.isFinite(totalBid) ? totalBid.toLocaleString(undefined, { maximumFractionDigits: 2 }) : "0.00"}
                    </strong>
                  </div>
                  <p className="mt-3 text-[0.86rem] leading-7 text-[#6D7484]">
            ...
            <div className="mt-6 rounded-[28px] border border-[#DCE3EF] bg-white/76 p-5">
              <span className="text-[0.66rem] font-extrabold uppercase tracking-[0.18em] text-[#6D7484]">
                Execution details
              </span>
              <div className="mt-4 grid gap-4">
                {[
                  ...
                  <div key={label}>
                    ...
                    <p className="mt-1 text-[0.94rem] leading-7 text-[#6D7484]">{value}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <article className="rounded-[32px] border border-[#DCE3EF] bg-[rgba(255,252,247,0.94)] p-6 shadow-[0_24px_70px_rgba(46,41,31,0.07)]">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {[
                ...
                <div key={item.title} className="rounded-[24px] border border-[#DCE3EF] bg-white/78 p-4">
                  <strong className="block font-display text-[1.02rem] tracking-[-0.04em] text-[#0F1115]">
                    {item.title}
                  </strong>
                  <p className="mt-3 text-[0.92rem] leading-7 text-[#6D7484]">{item.copy}</p>
                </div>
              ))}
            </div>
          </article>
          ...
          <article className="rounded-[32px] border border-[#DCE3EF] bg-[rgba(255,252,247,0.94)] p-6 shadow-[0_24px_70px_rgba(46,41,31,0.07)]">
            ...
            <div className="mt-4 grid gap-4">
              {[
                ...
                <div key={label} className="rounded-[22px] border border-[#DCE3EF] bg-white/76 px-4 py-4">
...
function BidMeta({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-[22px] border border-[#DCE3EF] bg-white/76 px-4 py-4">
      <span className="text-[0.64rem] font-extrabold uppercase tracking-[0.16em] text-[#6D7484]">
        {label}
      </span>
      <strong className="mt-2 block text-[1rem] tracking-[-0.02em] text-[#0F1115]">{value}</strong>
    </div>
  );
}
