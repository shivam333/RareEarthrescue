...
export function RecyclerDashboardPage({
  ...
  return (
    <motion.main className="page bg-transparent" {...pageMotionProps}>
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(210,175,103,0.16),transparent_24%),radial-gradient(circle_at_88%_12%,rgba(121,161,144,0.16),transparent_30%),linear-gradient(180deg,#F6F8FC_0%,#F6F8FC_56%,#F6F8FC_100%)] pb-12 pt-28">
        ...
        <div className="shell relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="max-w-[12ch] font-display text-[clamp(3rem,5.2vw,5.2rem)] leading-[0.95] tracking-[-0.06em] text-[#0F1115]">
              Open live category boards built for rare earth recovery buyers.
            </h1>
            <p className="mt-5 max-w-[46rem] text-[1.04rem] leading-8 text-[#6D7484]">
      ...
      <section className="shell section-gap pt-8">
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.72fr)]">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="rounded-[30px] border border-[#DCE3EF] bg-white/84 p-5 shadow-[0_20px_56px_rgba(46,41,31,0.06)]">
              <span className="text-[0.62rem] font-extrabold uppercase tracking-[0.18em] text-[#6D7484]">
                Quick actions
              </span>
